            ...
            <div className="order-2 lg:order-2 text-center lg:text-left space-y-6 lg:space-y-8">
              ...
              <div className="flex justify-center lg:justify-start space-x-4 sm:space-x-6">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group p-3 rounded-full bg-gray-200 hover:bg-black transition-colors duration-300"
                >
                  <Github
                    size={22}
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group p-3 rounded-full bg-gray-200 hover:bg-[#0077B5] transition-colors duration-300"
                >
                  <Linkedin
                    size={22}
                    className="fill-gray-700 group-hover:fill-white"
                ...
                <a
                  href="mailto:nitishb057@gmail.com"
                  className="group p-3 rounded-full bg-gray-200 hover:bg-red-600 transition-colors duration-300"
                >
                  <Mail
                    size={22}
                    className="stroke-gray-700 group-hover:stroke-white"
                  />
                </a>
              </div>
