...
const Hero = ({ roles, scrollToSection }) => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Hide arrow when scrolled more than 100px
  ...
  return (
    <section id="hero" className="min-h-screen flex items-center justify-center relative pt-20 sm:pt-24 md:pt-16 overflow-hidden">
        ...
        <div ref={ref} className={`fade-in-section ${isVisible ? 'visible' : ''}`}>
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="order-1 lg:order-2 text-center lg:text-left space-y-6 lg:space-y-8">
              ...
              Software Engineer building intelligent workflows, full-stack web applications, and AI-powered solutions.
              </p>
