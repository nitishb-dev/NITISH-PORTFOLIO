  ...
  const projects = [
    {
      ...
      description: "Built an AI-powered resume analyzer that compares resumes against job descriptions. Built with React, TypeScript & N8N workflows. Get match scores, keyword suggestions & improvement tips. Upload resume as PDF & paste text of JD for instant analysis.",
      image: airesumehelper,
      technologies: ["n8n", "JavaScript", "Gemini API", "ReactJS" , "TailwindCSS" ,"Text Extraction", "AI Autoamtion"],
      type: "AI", //
    ...
    },
    {
      ...
      description: "Built an LSTM-based model using Keras to classify 50,000 IMDB reviews with 88% accuracy. Applied advanced NLP techniques on Kaggle dataset using Python.",
      image: nlpImage,
      technologies: ["Python", "TensorFlow", "Keras", "NLP", "Google Colab", "Scikit-learn"],
    ...
    },
    {
      ...
      description: "Automated daily motivational quote posts on Twitter using n8n, OpenAI, and Google Sheets with image support, cron scheduling, and duplicate detection.",
      image: twitterImage,
    ...
    },
    {
      ...
      description: "Created an interactive dashboard to analyze Superstore sales (15.6L+ revenue, ₹1.75L profit). Used DAX for KPIs, trend analysis, and segment-wise insights.",
      image: powerBIImage,
      technologies: ["Power BI", "DAX", "Power Query", "Data Visualization"],
      type: "report", // Report project
      reportUrl: "https://drive.google.com/file/d/1HWQg_Onf5e1BrLbyd0cAy68hzoM7iSAd/view?usp=drive_link",
      featured: true
    },
    {
      title: "Cloud-Native Todo App with AWS & React",
      description: "Developed a serverless Todo app with React.js (Vercel) frontend, AWS Lambda (Python) backend, and MySQL (RDS). Enabled secure CRUD operations and scalable deployment.",
      image: todoImage,
      technologies: ["React.js", "AWS Lambda", "API Gateway", "MySQL", "Vercel", "Python"],
    ...
    },
    {
      ...
      description: "Automated login, search, and checkout flows on Amazon using Selenium WebDriver with Java and TestNG. Ensured functional testing and regression coverage.",
      image: seleniumImage,
