...
const Publications = () => {
  ...
  const publications = [
    {
      title: "Investigation on Generative Autoencoders for Hand Gesture Recognition",
      type: "Book Chapter",
      chapter: "Chapter 7",
      ...
      role: "Co-Author",
      year: "2024",
      description: "Developed and compared machine learning models (KNN, Decision Tree, SVM, Autoencoders) on the LeapGestRecog dataset (20,000 images). Achieved 99.98% accuracy using SVM with RBF kernel and Autoencoder.",
      highlights: [
      ...
      technologies: ["Python", "Machine Learning", "SVM", "Autoencoders", "PCA"],
        ...
        <div ref={ref} className={`scroll-fade-section ${isVisible ? 'visible' : ''}`}>
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-base sm:text-lg md:text-xl text-gray-600 max-w-3xl mx-auto px-4 sm:px-0">
              Academic contributions and research work in machine learning and AI
            </p>
          </div>
            ...
            <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-4 sm:p-6 border border-green-200">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-bold text-gray-900">ORCID Profile</h3>
                    <p className="text-sm text-gray-600">Researcher identifier and publication record</p>
                  </div>
                </div>
                <a
